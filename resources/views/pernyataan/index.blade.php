  ...
  <body data-sidebar="dark" data-layout-mode="light">
          ...
          <div class="modal-body">
            <form id="registerForm">
              ...
              <div class="mb-3">
                ...
                <input type="number" name="Urutan" id="Urutan" class="form-control" placeholder="Contoh: 1, 2, 3 dst.">
              ...
              <div class="mb-3">
                <label for="recipient-name" class="col-form-label">Pernyataan:</label>
                <input type="text" name="Pernyataan" id="Pernyataan" class="form-control" placeholder="Masukan kalimat pernyataan disini">
                <span class="help-block"></span>
    ...
    <script>
      ...
      function openModal() {
        ...
        $('#registerForm').find(".mb-3").removeClass("has-error");
        $('.help-block').empty();
        $('#modalForm').modal('show');
        $('.modal-title').text('Tambah Pernyataan');
        //$('#Pernyataan').summernote('reset');
      }
      ...
      function edit(id) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $('[name="Pernyataan"]').val(data.data.Pernyataan);
            //$('#Pernyataan').summernote('code', data.data.Pernyataan);
