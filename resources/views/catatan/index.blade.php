  ...
  <body data-sidebar="dark" data-layout-mode="light">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <p class="card-title-desc">Catatan tambahan diluar lampiran CV.</p>
                    <hr>
    ...
    <script>
      ...
      function openModal() {
        ...
        $('.modal-title').text('Tambah Catatan Tambahan');
      ...
      function edit(id) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $('#modalForm').modal('show');
            $('.modal-title').text('Edit Catatan Tambahan');
            $('#btnSave').text('Update');
          },
      ...
      function save(e) {
        if ($('#Keterangan').summernote('isEmpty')) {
          ...
          var url;
          if(save_method == 'add') {
            url = "{{ route('catatan.save') }}";
          } else {
            url = "{{ route('catatan.update') }}";
          }
      ...
      $(document).ready(function () {
        ...
        $('#Keterangan').summernote({
          height: 300,
          placeholder: 'Catatan tambahan diluar lampiran CV',
          toolbar: [
            [ 'style', [ 'style' ] ],
