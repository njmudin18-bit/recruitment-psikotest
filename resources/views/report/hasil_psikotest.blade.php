...
<html lang="en">
  ...
  <body data-sidebar="dark" data-layout-mode="light">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="datatable-buttons" class="table table-bordered table-striped dt-responsive nowrap w-100 dataTable" width="100%">
                        <thead>
    ...
    <script>
      ...
      //FUNCTION HAPUS
      function hapus(id, NamaPeserta, NamaUjian) {
        Swal.fire({
          title: "Anda yakin?",
          text: "Ingin menghapus data " + NamaPeserta + " ?",
          icon: "question",
